...
class WebFunctions:
    ...
    def Translate(self, text, lang=None):
        ...
        self.brw.find_element(By.XPATH, '//*[@id="yDmH0d"]/c-wiz/div/div[2]/c-wiz/div[2]/c-wiz/div[1]/div[1]/c-wiz/div[1]/c-wiz/div[5]/button/div[3]').click()
        time.sleep(0.7)
        if lang is not None:
            self.brw.find_element(By.XPATH, '//*[@id="yDmH0d"]/c-wiz/div/div[2]/c-wiz/div[2]/c-wiz/div[1]/div[1]/c-wiz/div[2]/c-wiz/div[2]/div/div[2]/input').send_keys(lang)
            self.brw.find_element(By.XPATH, '//*[@id="yDmH0d"]/c-wiz/div/div[2]/c-wiz/div[2]/c-wiz/div[1]/div[1]/c-wiz/div[2]/c-wiz/div[2]/div/div[2]/input').send_keys(Keys.ENTER)
        else:
            self.brw.find_element(By.XPATH, '//*[@id="yDmH0d"]/c-wiz/div/div[2]/c-wiz/div[2]/c-wiz/div[1]/div[1]/c-wiz/div[2]/c-wiz/div[2]/div/div[2]/input').send_keys("Português")
            self.brw.find_element(By.XPATH, '//*[@id="yDmH0d"]/c-wiz/div/div[2]/c-wiz/div[2]/c-wiz/div[1]/div[1]/c-wiz/div[2]/c-wiz/div[2]/div/div[2]/input').send_keys(Keys.ENTER)
        self.brw.find_element(By.CLASS_NAME, 'er8xn').send_keys(text)
        if len(self.brw.find_elements(By.CLASS_NAME, 'ryqvb')) >= 1:
            translated = self.brw.find_element(By.CLASS_NAME, 'ryNqvb')
            return translated
        elif len(self.brw.find_elements(By.CLASS_NAME, 'HwtZe')) >= 1:
            translated = self.brw.find_element(By.CLASS_NAME, 'HwtZe')
            return translated
        else:
            pass
...
class MathCB:
    ...
    def f_hipo(self, tria, round_=False):
        if type(tria) is self.Triangle:
            ...
            hipotenusa = self.sqrt(cato ** 2 + cata ** 2)
            if round_ is False or round_ is 0 or round_ == "n" or round_ == "N":
                return hipotenusa
            else:
                hipotenusa = round(hipotenusa, 3)
                return hipotenusa
